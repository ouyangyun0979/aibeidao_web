...
public class RandImgCreater {
    ...
    private static final int FONT_NUM = 5;
    private int width = 0;
    private int iNum = 0;
    ...
    public RandImgCreater(HttpServletResponse response,int iNum,String codeList) {
        this.response = response;
        this.width = 20 * iNum + 18;
        this.iNum = iNum;
        this.codeList = codeList;        
    }
    
    public ImageBean createRandImage(){
        ...
        for (int i=0;i<iNum;i++){
            ...
            g.drawString(strRand,20*i+8,21);
        }
        g.dispose();
        bean.setImage(image);
        bean.setCodestr(sRand);
        return bean;
    }
